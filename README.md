...
If using the built-in Jupyter webserver take note of the "Range" header requirements desribed here: [Server Requirements](https://github.com/igvteam/igv.js/wiki/Server-Requirements).
