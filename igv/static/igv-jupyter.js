...
define([
    "base/js/namespace",
    "jquery",
    IGV_PATH + "igvjs/igv-0.2.0.min.js"], function(Jupyter) {
    ...
    function is_css_loaded() {
        return $("link[href='" + IGV_PATH + "igvjs/igv-0.2.0.css']").length > 0;
    }

    function load_css() {
        $("head").append('<link rel="stylesheet" type="text/css" href="' + IGV_PATH + 'igvjs/igv-0.2.0.css">');
    }
